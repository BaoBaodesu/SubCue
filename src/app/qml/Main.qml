...
ApplicationWindow {
    ...
    palette {
        ...
        base: Theme.input
        alternateBase: Theme.panelSecondary
        text: Theme.text
        button: Theme.button
        buttonText: Theme.text
        highlight: Theme.selection
        highlightedText: Theme.text
        placeholderText: Theme.placeholder
        mid: Theme.divider
        midlight: Theme.panelRaised
        dark: Theme.border
        light: Theme.panelSecondary
        shadow: Theme.divider
    ...
    Component.onCompleted: {
        ...
        nativeTheme.applyDarkTitleBar(window, Theme.titleBar, Theme.text, Theme.border)
    }
    onVisibilityChanged: if (visible && typeof nativeTheme !== "undefined" && nativeTheme)
        nativeTheme.applyDarkTitleBar(window, Theme.titleBar, Theme.text, Theme.border)
